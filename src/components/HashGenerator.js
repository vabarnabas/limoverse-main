            ...
            <div className="bg-secondary py-7 px-8 rounded-md w-4/5 flex items center justify-center flex-col sm:w-2/5">
                ...
                <form action="" className="flex flex-wrap items-center justify-center" onSubmit={generateHash}>
                    <div className="flex flex-col mb-3 mx-5">
                        ...
                        <input required value={email} onChange={(e) => setEmail(e.target.value)} type="text" className="py-1 px-2 text-white rounded-md bg-tertiary border hover:bg-quaternary"/>
                    </div>
                    <div className="flex flex-col mb-3 mx-5">
                        <p className="text-white text-sm mb-1 font-semibold">Telefonszám<span className="text-red-500 font-semibold">*</span></p>
                        <input required value={phone} onChange={(e) => setPhone(e.target.value)} type="tel" className="py-1 px-2 text-white rounded-md bg-tertiary border hover:bg-quaternary"/>
                    </div>
                    <div className="flex flex-col mb-3 mx-5">
                        <p className="text-white text-sm mb-1 font-semibold">Jogosítvány szám<span className="text-red-500 font-semibold">*</span></p>
                        <input required value={license} onChange={(e) => setLicense(e.target.value)} type="text" className="py-1 px-2 text-white rounded-md bg-tertiary border hover:bg-quaternary"/>
                    </div>
                    <div className="flex flex-col mb-3 mx-5">
                        <p className="text-white text-sm mb-1 font-semibold">Születési Dátum<span className="text-red-500 font-semibold">*</span></p>
                        <input required value={birthday} onChange={(e) => setBirthday(e.target.value)} type="date" className="py-1 px-2 text-white rounded-md bg-tertiary border hover:bg-quaternary"/>
                    </div>
